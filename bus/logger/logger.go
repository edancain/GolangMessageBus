...
var (
	...
	// Each logging operation makes a single call to the Writer's Write method. A Logger can be used simultaneously
	// from multiple goroutines; it guarantees to serialize access to the Writer.
